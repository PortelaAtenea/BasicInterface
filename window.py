...
"background-color: rgb(239, 219, 255);")
        ...
        icon.addPixmap(QtGui.QPixmap("img/calendario.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap("img/calendario.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
