...
class Ui_Window(object):
    def setupUi(self, MainWindow):
        ...
        self.btnAceptar.setGeometry(QtCore.QRect(270, 330, 75, 23))
        self.btnAceptar.setObjectName("btnAceptar")
        self.lblTitulo = QtWidgets.QLabel(self.centralwidget)
        self.lblTitulo.setGeometry(QtCore.QRect(240, 170, 191, 51))
        font = QtGui.QFont()
        ...
        self.txtDatos.setGeometry(QtCore.QRect(240, 300, 221, 20))
        self.txtDatos.setObjectName("txtDatos")
        self.btnSalir = QtWidgets.QPushButton(self.centralwidget)
        self.btnSalir.setGeometry(QtCore.QRect(360, 330, 75, 23))
